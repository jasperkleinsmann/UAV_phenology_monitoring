...
# Script that contains the code for specific visualisations. The plots have been stored in objects and can be called in other scripts when desired
...
# SOS
ndvi.sos <- ggplot(pheno, aes(x=SpecieName, y=NDVI.SOS, fill=SpecieName))+
  geom_boxplot()+
...
evi.sos <- ggplot(pheno, aes(x=SpecieName, y=EVI.SOS, fill=SpecieName))+
  geom_boxplot()+
  ylim(ylim_sos)+
  ...
  scale_fill_viridis(discrete=T)
osavi.sos <- ggplot(pheno, aes(x=SpecieName, y=MCOSAVI.SOS, fill=SpecieName))+
  geom_boxplot()+
  ylim(ylim_sos)+
  ...
  stat_summary(fun.y=mean, geom="point", shape=20, size=2, color="orange", fill="orange", alpha=0.5)+
  scale_fill_viridis(discrete=T)
cire.sos <- ggplot(pheno, aes(x=SpecieName, y=CIRE.SOS, fill=SpecieName))+
  geom_boxplot()+
  ylim(ylim_sos)+
...
# EOS
ndvi.eos <- ggplot(pheno, aes(x=SpecieName, y=NDVI.EOS, fill=SpecieName))+
  geom_boxplot()+
  ...
  scale_fill_viridis(discrete=T)+
  ylim(ylim_eos)
evi.eos <- ggplot(pheno, aes(x=SpecieName, y=EVI.EOS, fill=SpecieName))+
  geom_boxplot()+
  labs(title = ' ', subtitle = 'EVI2', y='DOY')+
  theme(legend.position = 'none', axis.title.x=element_blank(),
        plot.subtitle = element_text(color = "black", size=10, face='italic'),
  ...
  scale_fill_viridis(discrete=T)+
  ylim(ylim_eos)
osavi.eos <- ggplot(pheno, aes(x=SpecieName, y=MCOSAVI.EOS, fill=SpecieName))+
  geom_boxplot()+
  labs(title = ' ', subtitle = 'OSAVI', y='DOY')+
  theme(legend.position = 'none', axis.title.x=element_blank(),
        plot.subtitle = element_text(color = "black", size=10, face='italic'),
  ...
  scale_fill_viridis(discrete=T)+
  ylim(ylim_eos)
cire.eos <- ggplot(pheno, aes(x=SpecieName, y=CIRE.EOS, fill=SpecieName))+
  geom_boxplot()+
  ylim(ylim_eos)+
  labs(title = ' ', subtitle = 'CIre', y='DOY')+
  theme(legend.position = 'none', axis.title.x=element_blank(),
